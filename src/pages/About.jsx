                ...
                <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                    ...
                    <div className="md:7/12 lg:w-6/12">
                        ...
                        <div className="space-y-4 text-gray-600">
                            ...
                            <p>
                                Recently, I was enrolled in the University of Richmond Coding Bootcamp with EdX, focusing on Full Stack Development. I graduated from the program, learning everything from HTML and CSS to Node.js and React, and I'm excited to apply these skills to real-world projects.
                            </p>
                            <p>
                            ...
                            <p>
                                When I'm not coding, you can find me gaming, researching technologies, coding, or reading a good book. I'm thrilled to be on this exciting journey and can't wait to see where it takes me in the world of web development! Feel free to connect with me on LinkedIn or explore my projects on GitHub - I'm always excited to collaborate with fellow developers and tech enthusiasts.
                            </p>
                        </div>
                    </div>
                </div>
